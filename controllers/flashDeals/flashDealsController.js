...
module.exports = {
    getAllFlashDeals: getAllFlashDeals,
    getFlashDealByID: getFlashDealByID,
    addFlashDeal: addFlashDeal,
    updateFlashDeal: updateFlashDeal,
    deleteFlashDealByID: deleteFlashDealByID,
    addProductToFlashDeal: addProductToFlashDeal,
    updateProductinFlashDeal: updateProductinFlashDeal,
    deleteProductInFlashDeal: deleteProductInFlashDeal,
}